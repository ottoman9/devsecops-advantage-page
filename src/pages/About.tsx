            ...
            <div className="bg-white/5 rounded-2xl p-8 border border-white/10 animate-fade-in" style={{ animationDelay: "300ms" }}>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h4 className="text-lg font-semibold text-white mb-1">Certified Kubernetes Administrator (CKA)</h4>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h4 className="text-lg font-semibold text-white mb-1">DevSecOps Specialist</h4>
