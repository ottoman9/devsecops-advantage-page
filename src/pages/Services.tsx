...
import { ArrowRight, GitMerge, Cloud, Shield, BarChart, HardDrive, Package2, Code, MoveRight, Activity, FileCheck } from "lucide-react";
...
const servicesList = [
  ...
  {
    icon: <MoveRight className="h-10 w-10" />,
